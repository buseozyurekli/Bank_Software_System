...
namespace BankaYazilimOtomasyonu
{
    public class Hesap : Musteri , IHesapIslemleri
    {
        ...
        public string ParaYatirma(double miktar, int hesapNo) // Müşterinin kendi hesabına para yatırma işlemleri burada gerçekleştirilir.
        {
            ...
            foreach (Hesap h in Hesaplar)
            {
                if (hesapNo == h.HesapNo)
                {
                    ...
                    Ozetler.Add(i); // Yapılan işlemler özetler listesine eklenir.
        ...
        public string HesabaHavale(double miktar, int hesapNo1, int hesapNo2) // Müşterinin kendi hesabından başka hesaba para yatırma (havale) işlemi burada yapılır.
        {
            string mesaj = "";
        ...
        public string[] BankaBilgiGoster() // Bankanın tüm gelir giderleri burada gösterilir.
        {
            Hesap h = new Hesap();
            Banka b = new Banka();
            b.Gelir = 0;
